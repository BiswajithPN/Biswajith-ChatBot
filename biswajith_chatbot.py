...
/* Gradient only on the stApp wrapper */
.stApp {
    background:
        radial-gradient(ellipse at top left, rgba(191,148,79,0.10) 0%, transparent 40%),
...
with st.sidebar:
    ...
    <div class="profile-name">Biswajith PN</div>
    <div class="profile-role">AI & Data Science Student</div>
    <div class="profile-bio">Practical builder focused on AI products and applied software work.</div>
    """, unsafe_allow_html=True)
    ...
    tags = ["AI/ML", "RAG", "LangChain", "Streamlit", "App Dev", "Video Editing", "Chatbots"]
    st.markdown(
        '<div class="tags-wrap">' +
    ...
    <div class="info-card">
        ...
        <span>Video edits &amp; creative content</span>
    </div>
    """, unsafe_allow_html=True)
